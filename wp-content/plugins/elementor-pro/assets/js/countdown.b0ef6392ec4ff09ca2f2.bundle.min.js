                ...
                getEvergreenDate() {
                    const e = this,
                        ...
                        initEvergreen = function() {
                            var t = new Date;
                            return e.cache.data.endTime = t.setSeconds(t.getSeconds() + n), localStorage.setItem(a, e.cache.data.endTime), localStorage.setItem(r, n), e.cache.data.endTime
                        };
